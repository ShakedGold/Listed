...
<template>
  <div class="absolute z-10 bottom-0 left-0 flex gap-2 items-center p-2">
    <div
      class="p-2 rounded-bl-[0.6rem] rounded-lg bg-opacity-50 text-xl w-16 backdrop-blur-sm "
      :style="{
        backgroundColor: bg,
    ...
    >
      <div
        class="object-cover w-[45px] rounded-full backdrop-blur-sm cursor-pointer"
        :style="{
          backgroundColor: bg,
        }"
  ...
  <div
    class="absolute right-0 bottom-0 flex gap-2 transition-all duration-200 ease-in-out p-2"
    :class="isHovering ? 'opacity-100' : 'opacity-0'"
  >
    <div
      class="rounded-full backdrop-blur-sm cursor-pointer"
      :style="{
        backgroundColor: bg,
      }"
